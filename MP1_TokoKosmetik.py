...
class TokoKosmetik:
    ...
    def tambah_produk(self, produk):
        ...
        elif any(existing_produk.kode == produk.kode for existing_produk in self.produk_list):
            print("Produk dengan kode tersebut sudah ada. Gunakan kode yang berbeda.")
        else:
    ...
    def hapus_produk(self, kode):
        try:
            index_produk = next(i for i, produk in enumerate(self.produk_list) if produk.kode == kode)
...
def main():
    ...
    while True:
        ...
        try:
            pilihan = int(input("Masukkan pilihan Anda: "))  # Meminta pengguna memilih opsi
            os.system("cls")
        except ValueError:
        ...
        if pilihan == 1:
            try:
                ...
                # Menambahkan produk baru ke toko_kosmetik
                toko_kosmetik.tambah_produk(produk_baru)
            except ValueError:
                print("Kode Barang Sudah tersedia atau Masukkan nilai yang valid untuk harga dan stok.")
                continue
            ...
            print("Terima kasih telah berkunjung ke program ini.")
            break
